...
Perhaps a metaphor will help. A Class can be thought of like a blueprint for making a coffee mug. The Class describes all the elements and functions of a coffee mug, such as the handle, the cup, the decoration, etc. Objects are the actual coffee mugs that you produce from the blueprints.

...
experiment is visualised in Figures 1 and 2, which are screenshots taken
...
<caption>Fig. 1 The top ten predictions generated by RoBERTa for the masked token in the sentence ‘The rose `<mask>` red.’</caption>
</table>
...
<tr><td>makes</td>0.1458<td></td></tr>
<tr><td>times</td>0.1257<td></td></tr>
...
<caption> Fig. 2 The top ten predictions generated by RoBERTa for the masked token in the sentence ‘Two times two `<mask>` four.’</caption>
</table>
...
Wittgenstein. In Figure 1, there are past tense forms of verbs, often
more probable than the corresponding present tense. In Figure 2, one of
...
of life. Consider, for instance, in Figure 3, the predictions generated
by RoBERTa for the masked token in the following sentence, which differs
from the first one only in the interposition of the phrase ‘in my
opinion’: ‘The rose, in my opinion, \<mask\> red.’
...
<caption>Fig. 3 The top ten predictions generated by RoBERTa for the masked token in the sentence ‘The rose, in my opinion, `<mask>` red.’</caption>
</table>
